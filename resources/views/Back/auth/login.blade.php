...
<head>
    ...
    <title>Blog Site Admin - Giriş</title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                @foreach($errors->all() as $error)
                                    <div class="alert alert-danger text-capitalize" >{{$error}}</div>
                                @endforeach
                                <form method="post" action="{{route('dashboard.post_login')}}" class="user">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">
                                            <input type="checkbox" class="custom-control-input" id="customCheck" value="1"  name="remember_me" >
...
<!-- Custom scripts for all frontpages-->
